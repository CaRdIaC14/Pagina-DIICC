  				                  ...
  				                  <div class="container">
                                      <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"></div>
                                            <button type="button" class="btn btn-basic btn-lg" data-toggle="modal" data-target="#AnNot">Añadir Noticia</button>
                                            <?php
			                                    if (isset($Exito)) {
  					                             ...
  					                             <div class="table-responsive">
  						                            <table class="table">
                                                         ...
                                                         <tbody>
													        ...
													        ?>
                                                         	 <form action="ModificarNoticia.php" method="post" autocomplete="off">
                                                             <tr>
                                                             	<td style="display: none;"><input type="text" name="id" value="<?php echo $mostrar['id']; ?>" size="50" maxlength="50" ></td>
                                                                 <td><input type="text" name="titulo" value="<?php echo $mostrar['titulo']; ?>" size="50" maxlength="50" ></td>
                                                                 <td><textarea name="descripcion"> <?php echo $mostrar['descripcion']; ?></textarea></td>
                                                        	...
                                                        	<form action="eliminarNoticia.php" method="post" autocomplete="off">
                                                                <td>
                                                                	<input type="text" name="id" value="<?php echo $mostrar['id']; ?>" style="display: none;">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="panel-heading">
					                                       <div class="panel-title"><h3>Llena los siguientes campos:</h3></div>
					                                   </div>

                                                        <div class="panel-body">
                                                            <form class="form-horizontal" role="form" action="crearNoticia.php" method="post">
                                                              <div class="form-group">
                                                                <label for="Titulo" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Titulo</label>
                                                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                                  <input type="text" class="form-control" name="Titulo" placeholder="" required="">
                                                                </div>
                                                              </div>
                                                              <div class="form-group">
                                                                  <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Descripcion</label>
                                                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                             ...
                                                             <div class="form-group">
                                                                ...
                                                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                                  <input type="file" name="img"  class="form-control" id="imgs">
                                                                </div>
                                                              </div>
